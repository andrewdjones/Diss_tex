...
%TODO: -Put unquant interonsets plot in Ch. 2?  (ch. 2, around p. 82, in the discussion for sliding keyfinding windows; also seems relevant to the beginning of ch. 3, so maybe end of ch. 2 really is a better place.)
...
%re-make this figure: it is lame.
\begin{figure}
	\centering
...
%cardinality at time scale stats?
\begin{landscape}
\begin{figure}
	\centering
...
\begin{figure}%[h]
	...
	\includegraphics[width=3.5in]{sds.png}
	\label{sds}
\end{figure}
