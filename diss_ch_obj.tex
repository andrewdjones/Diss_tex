...
Crucial to Kockelman's description of selection and significance is the claim that all agents performing (re)actions do so under some ontological assumptions, whether they are conscious or unconscious.  %put Martin/Levine in these terms, discuss modes of ontological transformation, put voicings, scales, and scale-degree sets in these terms to set up the rest of the diss?
